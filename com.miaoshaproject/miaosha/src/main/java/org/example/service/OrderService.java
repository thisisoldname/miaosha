...
public interface OrderService {
    ...
    OrderModel createOrder(Integer userId, String userName, Integer itemId, Integer promoId, Integer amount, String stockLogId, String userEmail) throws BussinessException;
}
